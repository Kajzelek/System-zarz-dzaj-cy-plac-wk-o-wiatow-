...
public class WiadomoscDAOImpl implements WiadomoscDAO {
    ...
    public List<Wiadomosc> findWiadomosciOdebraneById(int id) {
        TypedQuery<Wiadomosc> query = entityManager.createQuery("from Wiadomosc where odbiorca.id = :data", Wiadomosc.class);
    ...
    public List<Wiadomosc> findWiadomosciWyslaneById(int id) {
        TypedQuery<Wiadomosc> query = entityManager.createQuery("from Wiadomosc where nadawca.id = :data", Wiadomosc.class);
        query.setParameter("data", id);
        return query.getResultList();
    }
